...
export const routes: Routes = [
  ...
  { path: 'membres', loadComponent: () => import('./features/membres/membres.component').then(m => m.MembreComponent) },
  /* { path: 'cours', loadComponent: () => import('./features/cours/cours.component').then(m => m.CoursComponent) },
